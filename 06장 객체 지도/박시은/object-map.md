...
- 도메인 모델을 구성하는 개념 간 관계는
  - 비즈니스 규칙을 기반으로 하기 때문에
  - 정책이 크게 변하지 않는 한
  - 안정적으로 유지된다.
- 예)
  - 계좌와 이자의 관계
